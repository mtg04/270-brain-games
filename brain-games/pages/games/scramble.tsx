...
const WORDS = {
  easy: [
    // 3-letter
    "cat", "dog", "sun", "map", "pen", "cup", "hat", "bed", "car", "box",
    "run", "red", "top", "fan", "key", "lip", "net", "fog", "log", "bat",

    // 5-letter
    "apple", "grape", "stone", "plant", "chair", "table", "light", "sound",
    "water", "bread", "clock", "mouse", "train", "sweet", "green", "brown",
    "smile", "laugh", "drink", "bring", "crane", "flame", "glide", "pride",
    "trace", "blame", "frame", "shine", "spice", "slice"
  ],

  medium: [
    // 6-letter
    "planet", "bridge", "stream", "forest", "castle", "silver", "golden",
    "rocket", "puzzle", "jungle", "butter", "little", "battle", "travel",
    "animal", "memory", "random", "bright", "circle", "square",

    // 7-letter
    "teacher", "student", "country", "picture", "weather", "freedom",
    "problem", "success", "balance", "process", "journey", "capture",
    "monster", "network", "plastic", "traffic", "kitchen", "station",
    "diamond", "element"
  ],

  hard: [
    // longer 6–7+ mixed (harder due to structure)
    "complex", "dynamic", "program", "compute", "predict", "analyze",
    "iterate", "feature", "project", "compile", "execute", "optimize",
    "network", "storage", "virtual", "process", "thread", "library",

    // longer / trickier
    "function", "variable", "constant", "argument", "operator",
    "framework", "database", "component", "structure", "algorithm",
    "interface", "developer", "condition", "iteration", "parameter"
  ]
};
